...
import (
	...
	"github.com/Canto-Network/Canto/v6/testing/simapp"
)
...
func SetupTestingApp() (TestingApp, map[string]json.RawMessage) {
	db := dbm.NewMemDB()
	app := cantoapp.NewCanto(log.NewNopLogger(), db, nil, true, map[int64]bool{}, simapp.DefaultNodeHome, 5, encoding.MakeConfig(cantoapp.ModuleBasics), simapp.EmptyAppOptions{})
