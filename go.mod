...
require (
	...
	github.com/yihuang/go-block-stm v0.0.0-20240321085908-ff6b9b121972 // indirect
...
replace (
	...
	github.com/evmos/ethermint => github.com/b-harvest/ethermint v0.0.0-20240404092552-17039c90eb1f
