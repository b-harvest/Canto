...
func init() {
	...
	md_CommitInfo = File_memmemiavl_commit_info_proto.Messages().ByName("CommitInfo")
...
func (x *CommitInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_memmemiavl_commit_info_proto_msgTypes[0]
...
func (x *fastReflection_CommitInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "memmemiavl.CommitInfo.version":
		return x.Version != int64(0)
	case "memmemiavl.CommitInfo.store_infos":
		return len(x.StoreInfos) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.CommitInfo"))
		}
		panic(fmt.Errorf("message memmemiavl.CommitInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommitInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message memmemiavl.CommitInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommitInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "memmemiavl.CommitInfo.version":
		panic(fmt.Errorf("field version of message memmemiavl.CommitInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.CommitInfo"))
		}
...
func (x *fastReflection_CommitInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in memmemiavl.CommitInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_memmemiavl_commit_info_proto_init()
	md_StoreInfo = File_memmemiavl_commit_info_proto.Messages().ByName("StoreInfo")
...
func (x *StoreInfo) slowProtoReflect() protoreflect.Message {
	mi := &file_memmemiavl_commit_info_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_StoreInfo) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "memmemiavl.StoreInfo.name":
		return x.Name != ""
	case "memmemiavl.StoreInfo.commit_id":
		return x.CommitId != nil
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.StoreInfo"))
		}
		panic(fmt.Errorf("message memmemiavl.StoreInfo does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_StoreInfo) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message memmemiavl.StoreInfo does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_StoreInfo) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	...
	case "memmemiavl.StoreInfo.name":
		panic(fmt.Errorf("field name of message memmemiavl.StoreInfo is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.StoreInfo"))
		}
...
func (x *fastReflection_StoreInfo) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in memmemiavl.StoreInfo", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_memmemiavl_commit_info_proto_init()
	md_CommitID = File_memmemiavl_commit_info_proto.Messages().ByName("CommitID")
...
func (x *CommitID) slowProtoReflect() protoreflect.Message {
	mi := &file_memmemiavl_commit_info_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_CommitID) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "memmemiavl.CommitID.version":
		return x.Version != int64(0)
	case "memmemiavl.CommitID.hash":
		return len(x.Hash) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.CommitID"))
		}
		panic(fmt.Errorf("message memmemiavl.CommitID does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_CommitID) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message memmemiavl.CommitID does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_CommitID) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "memmemiavl.CommitID.version":
		panic(fmt.Errorf("field version of message memmemiavl.CommitID is not mutable"))
	case "memmemiavl.CommitID.hash":
		panic(fmt.Errorf("field hash of message memmemiavl.CommitID is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.CommitID"))
		}
...
func (x *fastReflection_CommitID) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in memmemiavl.CommitID", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: memmemiavl/commit_info.proto
...
func (*CommitInfo) Descriptor() ([]byte, []int) {
	return file_memmemiavl_commit_info_proto_rawDescGZIP(), []int{0}
}
...
func (*StoreInfo) Descriptor() ([]byte, []int) {
	return file_memmemiavl_commit_info_proto_rawDescGZIP(), []int{1}
}
...
func (*CommitID) Descriptor() ([]byte, []int) {
	return file_memmemiavl_commit_info_proto_rawDescGZIP(), []int{2}
}
...
var File_memmemiavl_commit_info_proto protoreflect.FileDescriptor

var file_memmemiavl_commit_info_proto_rawDesc = []byte{
	...
	,
}

var (
	file_memmemiavl_commit_info_proto_rawDescOnce sync.Once
	file_memmemiavl_commit_info_proto_rawDescData = file_memmemiavl_commit_info_proto_rawDesc
)

func file_memmemiavl_commit_info_proto_rawDescGZIP() []byte {
	file_memmemiavl_commit_info_proto_rawDescOnce.Do(func() {
		file_memmemiavl_commit_info_proto_rawDescData = protoimpl.X.CompressGZIP(file_memmemiavl_commit_info_proto_rawDescData)
	})
	return file_memmemiavl_commit_info_proto_rawDescData
}

var file_memmemiavl_commit_info_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_memmemiavl_commit_info_proto_goTypes = []interface{}{
	(*CommitInfo)(nil), // 0: memmemiavl.CommitInfo
	(*StoreInfo)(nil),  // 1: memmemiavl.StoreInfo
	(*CommitID)(nil),   // 2: memmemiavl.CommitID
}
var file_memmemiavl_commit_info_proto_depIdxs = []int32{
	1, // 0: memmemiavl.CommitInfo.store_infos:type_name -> memmemiavl.StoreInfo
	2, // 1: memmemiavl.StoreInfo.commit_id:type_name -> memmemiavl.CommitID
...
func init() { file_memmemiavl_commit_info_proto_init() }
func file_memmemiavl_commit_info_proto_init() {
	if File_memmemiavl_commit_info_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_memmemiavl_commit_info_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_memmemiavl_commit_info_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_memmemiavl_commit_info_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_memmemiavl_commit_info_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_memmemiavl_commit_info_proto_goTypes,
		DependencyIndexes: file_memmemiavl_commit_info_proto_depIdxs,
		MessageInfos:      file_memmemiavl_commit_info_proto_msgTypes,
	}.Build()
	File_memmemiavl_commit_info_proto = out.File
	file_memmemiavl_commit_info_proto_rawDesc = nil
	file_memmemiavl_commit_info_proto_goTypes = nil
	file_memmemiavl_commit_info_proto_depIdxs = nil
}
