...
func init() {
	file_memmemiavl_kv_proto_init()
	md_Pairs = File_memmemiavl_kv_proto.Messages().ByName("Pairs")
...
func (x *Pairs) slowProtoReflect() protoreflect.Message {
	mi := &file_memmemiavl_kv_proto_msgTypes[0]
...
func (x *fastReflection_Pairs) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "memmemiavl.Pairs.pairs":
		return len(x.Pairs) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.Pairs"))
		}
		panic(fmt.Errorf("message memmemiavl.Pairs does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pairs) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message memmemiavl.Pairs does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pairs) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in memmemiavl.Pairs", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_memmemiavl_kv_proto_init()
	md_Pair = File_memmemiavl_kv_proto.Messages().ByName("Pair")
...
func (x *Pair) slowProtoReflect() protoreflect.Message {
	mi := &file_memmemiavl_kv_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_Pair) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "memmemiavl.Pair.key":
		return len(x.Key) != 0
	case "memmemiavl.Pair.value":
		return len(x.Value) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.Pair"))
		}
		panic(fmt.Errorf("message memmemiavl.Pair does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Pair) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message memmemiavl.Pair does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Pair) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "memmemiavl.Pair.key":
		panic(fmt.Errorf("field key of message memmemiavl.Pair is not mutable"))
	case "memmemiavl.Pair.value":
		panic(fmt.Errorf("field value of message memmemiavl.Pair is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: memmemiavl.Pair"))
		}
...
func (x *fastReflection_Pair) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in memmemiavl.Pair", d.FullName()))
	}
	panic("unreachable")
}
...
func (*Pairs) Descriptor() ([]byte, []int) {
	return file_memmemiavl_kv_proto_rawDescGZIP(), []int{0}
}
...
func (*Pair) Descriptor() ([]byte, []int) {
	return file_memmemiavl_kv_proto_rawDescGZIP(), []int{1}
}
...
var File_memmemiavl_kv_proto protoreflect.FileDescriptor

var file_memmemiavl_kv_proto_rawDesc = []byte{
	0x0a, 0x10, 0x6d, 0x65, 0x6d, 0x69, 0x61, 0x76, 0x6c, 0x2f, 0x6b, 0x76, 0x2e, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x12, 0x07, 0x6d, 0x65, 0x6d, 0x69, 0x61, 0x76, 0x6c, 0x1a, 0x14, 0x67, 0x6f, 0x67,
	0x6f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x22, 0x32, 0x0a, 0x05, 0x50, 0x61, 0x69, 0x72, 0x73, 0x12, 0x29, 0x0a, 0x05, 0x70, 0x61,
	0x69, 0x72, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0d, 0x2e, 0x6d, 0x65, 0x6d, 0x69,
	0x61, 0x76, 0x6c, 0x2e, 0x50, 0x61, 0x69, 0x72, 0x42, 0x04, 0xc8, 0xde, 0x1f, 0x00, 0x52, 0x05,
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x42, 0x6c, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x65, 0x6d,
	0x69, 0x61, 0x76, 0x6c, 0x42, 0x07, 0x4b, 0x76, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a,
	0x18, 0x63, 0x6f, 0x73, 0x6d, 0x6f, 0x73, 0x73, 0x64, 0x6b, 0x2e, 0x69, 0x6f, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x6d, 0x65, 0x6d, 0x69, 0x61, 0x76, 0x6c, 0xa2, 0x02, 0x03, 0x4d, 0x58, 0x58, 0xaa,
	0x02, 0x07, 0x4d, 0x65, 0x6d, 0x69, 0x61, 0x76, 0x6c, 0xca, 0x02, 0x07, 0x4d, 0x65, 0x6d, 0x69,
	0x61, 0x76, 0x6c, 0xe2, 0x02, 0x13, 0x4d, 0x65, 0x6d, 0x69, 0x61, 0x76, 0x6c, 0x5c, 0x47, 0x50,
	0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea, 0x02, 0x07, 0x4d, 0x65, 0x6d, 0x69,
	0x61, 0x76, 0x6c, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_memmemiavl_kv_proto_rawDescOnce sync.Once
	file_memmemiavl_kv_proto_rawDescData = file_memmemiavl_kv_proto_rawDesc
)

func file_memmemiavl_kv_proto_rawDescGZIP() []byte {
	file_memmemiavl_kv_proto_rawDescOnce.Do(func() {
		file_memmemiavl_kv_proto_rawDescData = protoimpl.X.CompressGZIP(file_memmemiavl_kv_proto_rawDescData)
	})
	return file_memmemiavl_kv_proto_rawDescData
}

var file_memmemiavl_kv_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_memmemiavl_kv_proto_goTypes = []interface{}{
	(*Pairs)(nil), // 0: memmemiavl.Pairs
	(*Pair)(nil),  // 1: memmemiavl.Pair
}
var file_memmemiavl_kv_proto_depIdxs = []int32{
	1, // 0: memmemiavl.Pairs.pairs:type_name -> memmemiavl.Pair
...
func init() { file_memmemiavl_kv_proto_init() }
func file_memmemiavl_kv_proto_init() {
	if File_memmemiavl_kv_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_memmemiavl_kv_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pairs); i {
			case 0:
				return &v.state
			case 1:
		...
		file_memmemiavl_kv_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Pair); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_memmemiavl_kv_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_memmemiavl_kv_proto_goTypes,
		DependencyIndexes: file_memmemiavl_kv_proto_depIdxs,
		MessageInfos:      file_memmemiavl_kv_proto_msgTypes,
	}.Build()
	File_memmemiavl_kv_proto = out.File
	file_memmemiavl_kv_proto_rawDesc = nil
	file_memmemiavl_kv_proto_goTypes = nil
	file_memmemiavl_kv_proto_depIdxs = nil
}
