...
type MsgAdvanceEpoch struct {
	// requester_address is the address of the user who want to advance the epoch.
	RequesterAddress string `protobuf:"bytes,1,opt,name=requester_address,json=requesterAddress,proto3" json:"requester_address,omitempty"`
}
...
func (*MsgAdvanceEpoch) Descriptor() ([]byte, []int) {
	return fileDescriptor_a8b50b1abccb5854, []int{16}
}
...
func (m *MsgAdvanceEpoch) GetRequesterAddress() string {
	if m != nil {
		return m.RequesterAddress
	}
	return ""
...
func (*MsgAdvanceEpochResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a8b50b1abccb5854, []int{17}
}
...
func init() {
	...
	proto.RegisterType((*MsgAdvanceEpoch)(nil), "canto.liquidstaking.v1.MsgAdvanceEpoch")
	proto.RegisterType((*MsgAdvanceEpochResponse)(nil), "canto.liquidstaking.v1.MsgAdvanceEpochResponse")
}
...
var fileDescriptor_a8b50b1abccb5854 = []byte{
	...
	,
}
...
func (c *msgClient) AdvanceEpoch(ctx context.Context, in *MsgAdvanceEpoch, opts ...grpc.CallOption) (*MsgAdvanceEpochResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/canto.liquidstaking.v1.Msg/AdvanceEpoch", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_AdvanceEpoch_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/canto.liquidstaking.v1.Msg/AdvanceEpoch",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
