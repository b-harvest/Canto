...
const (
	...
	// a MsgProvideInsurance. This status indicates that the insurance is ready to be
	...
	// Once paired, the insurance contract can be cancelled using MsgCancelProvideInsurance.
