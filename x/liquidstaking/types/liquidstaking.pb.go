...
type NetAmountState struct {
	...
	// chunk's native token balance + Sum of token values of all chunk's delegation shares +
	// sum of all remaining rewards of paired chunks since last Epoch +
	// all unbonding delegation tokens of unpairing chunks
	...
	// This value is almost same with NetAmount except for remaining rewards of chunk.
	// When sum remaining rewards of chunk, it does not consider module fee.
	NetAmountBeforeModuleFee github_com_cosmos_cosmos_sdk_types.Dec `protobuf:"bytes,20,opt,name=net_amount_before_module_fee,json=netAmountBeforeModuleFee,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Dec" json:"net_amount_before_module_fee"`
}
...
var fileDescriptor_d5ab11aad71f7b33 = []byte{
	...
	,
}
...
func (m *NetAmountState) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size := m.NetAmountBeforeModuleFee.Size()
		i -= size
		if _, err := m.NetAmountBeforeModuleFee.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintLiquidstaking(dAtA, i, uint64(size))
	}
...
func (m *NetAmountState) Size() (n int) {
	...
	n += 2 + l + sovLiquidstaking(uint64(l))
	l = m.NetAmountBeforeModuleFee.Size()
	n += 2 + l + sovLiquidstaking(uint64(l))
	return n
}
...
func (m *NetAmountState) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NetAmountBeforeModuleFee", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.NetAmountBeforeModuleFee.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
